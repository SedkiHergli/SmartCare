...
var routes = [
    ...
    { path: 'tabs', loadChildren: './tabs/tabs.module#TabsModule', canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuardService"]] },
    { path: 'tabss', loadChildren: './tabss/tabss.module#TabssModule', canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuardService"]] },
...
module.exports = "<ion-app>\r\n  <ion-split-pane>\r\n    <ion-menu contentId=\"content\" type=\"overlay\" >\r\n      <ion-header>\r\n        <ion-toolbar style=\"--background: url(../assets/imgs/side.jpg);\">\r\n          <ion-title>Menu</ion-title>\r\n        </ion-toolbar>\r\n      </ion-header>\r\n   \r\n      <ion-content style=\"--background: url(../assets/imgs/side.jpg);\">\r\n        <ion-list style=\"background: transparent;\">\r\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of pages\">\r\n            <ion-item [href]=\"p.url\" routerDirection=\"root\">\r\n              <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\r\n              <ion-label>{{ p.title }}</ion-label>\r\n            </ion-item>\r\n          </ion-menu-toggle>\r\n          <ion-item (click)=\"logout()\">\r\n            <ion-icon slot=\"start\" name=\"log-out\"></ion-icon>\r\n            <ion-label>Logout</ion-label>\r\n          </ion-item>\r\n        </ion-list>\r\n   \r\n      </ion-content>\r\n   \r\n    </ion-menu>\r\n   \r\n    <ion-router-outlet id=\"content\" main></ion-router-outlet>\r\n   \r\n  </ion-split-pane>\r\n</ion-app>\r\n"
...
module.exports = ".split-pane-visible > .split-pane-side:not(ion-menu), .split-pane-visible > ion-menu.split-pane-side.menu-enabled {\n  display: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _tabs_tabs_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./tabs/tabs.module */ "./src/app/tabs/tabs.module.ts");
/* harmony import */ var _tabss_tabss_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./tabss/tabss.module */ "./src/app/tabss/tabss.module.ts");
/* harmony import */ var _services_location_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/location.service */ "./src/app/services/location.service.ts");
/* harmony import */ var _services_sensor_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/sensor.service */ "./src/app/services/sensor.service.ts");
/* harmony import */ var _services_emergency_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/emergency.service */ "./src/app/services/emergency.service.ts");
/* harmony import */ var _services_supervisor_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./services/supervisor.service */ "./src/app/services/supervisor.service.ts");
...
/* harmony import */ var _services_weather_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/weather.service */ "./src/app/services/weather.service.ts");
/* harmony import */ var _ionic_native_device_motion_ngx__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @ionic-native/device-motion/ngx */ "./node_modules/@ionic-native/device-motion/ngx/index.js");
/* harmony import */ var _services_motion_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./services/motion.service */ "./src/app/services/motion.service.ts");
/* harmony import */ var _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @ionic-native/network/ngx */ "./node_modules/@ionic-native/network/ngx/index.js");
...
/* harmony import */ var _ionic_native_phonegap_local_notification_ngx__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @ionic-native/phonegap-local-notification/ngx */ "./node_modules/@ionic-native/phonegap-local-notification/ngx/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"],
                ...
                _tabs_tabs_module__WEBPACK_IMPORTED_MODULE_12__["TabsModule"],
                _tabss_tabss_module__WEBPACK_IMPORTED_MODULE_13__["TabssModule"],
            ],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_5__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_4__["SplashScreen"],
                _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_8__["Geolocation"],
                _ionic_native_phonegap_local_notification_ngx__WEBPACK_IMPORTED_MODULE_26__["PhonegapLocalNotification"],
                _ionic_native_call_number_ngx__WEBPACK_IMPORTED_MODULE_25__["CallNumber"],
                _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_24__["Network"],
                _services_motion_service__WEBPACK_IMPORTED_MODULE_23__["MotionService"],
                _ionic_native_device_motion_ngx__WEBPACK_IMPORTED_MODULE_22__["DeviceMotion"],
                _services_location_service__WEBPACK_IMPORTED_MODULE_14__["LocationService"],
                ...
                _services_supervisor_service__WEBPACK_IMPORTED_MODULE_17__["SupervisorService"],
                _services_sensor_service__WEBPACK_IMPORTED_MODULE_15__["SensorService"],
                _services_emergency_service__WEBPACK_IMPORTED_MODULE_16__["EmergencyService"],
                _services_weather_service__WEBPACK_IMPORTED_MODULE_21__["WeatherService"],
...
/***/ "./src/app/pages/accountu/accountu.module.ts":
/*!***************************************************!*\
  !*** ./src/app/pages/accountu/accountu.module.ts ***!
  \***************************************************/
/*! exports provided: AccountuPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccountuPageModule", function() { return AccountuPageModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _accountu_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./accountu.page */ "./src/app/pages/accountu/accountu.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _accountu_page__WEBPACK_IMPORTED_MODULE_5__["AccountuPage"]
    }
];
var AccountuPageModule = /** @class */ (function () {
    function AccountuPageModule() {
    }
    AccountuPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
            ...
            declarations: [_accountu_page__WEBPACK_IMPORTED_MODULE_5__["AccountuPage"]]
        })
    ], AccountuPageModule);
    return AccountuPageModule;
}());
...
/***/ "./src/app/pages/accountu/accountu.page.html":
/*!***************************************************!*\
  !*** ./src/app/pages/accountu/accountu.page.html ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\r\n  <ion-toolbar style=\"--background: url(../assets/imgs/background16.jpg);\">\r\n    <ion-buttons slot=\"start\">\r\n      <ion-menu-button></ion-menu-button>\r\n    </ion-buttons>\r\n    <ion-title>My Account</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n \r\n<ion-content style=\"--background: url(assets/imgs/background16.jpg) center / 100%;\" padding>\r\n  <div class=\"col-container\" style=\"background: #ffffff40;border-style: solid;border-color: #ffffff40;\">\r\n      <div class=\"col\" (click)=\"openWeather()\">\r\n                      <img src=\"assets/imgs/temp.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\r\n                  <p style=\"text-align: center\">\r\n                    {{temp}}\r\n                  </p>\r\n      </div>\r\n    <br>\r\n          <div class=\"col\" (click)=\"openWeather()\">\r\n                      <img src=\"assets/imgs/humidity.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\r\n                      <p style=\"text-align: center\">\r\n                      {{humidity}}\r\n                     </p>\r\n          </div>\r\n          <div class=\"col\" (click)=\"openWeather()\">\r\n                    <img [src]='weather.icon' style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\r\n                    <p style=\"text-align: center\">\r\n                    {{weather.description}}\r\n                    </p>\r\n         </div>\r\n        </div>\r\n        <div class=\"col-container\" style=\"background: #ffffff40;border-style: solid;border-color: #ffffff40;\">\r\n            <div class=\"col\">\r\n                            <img src=\"assets/imgs/level.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\r\n                        <p style=\"text-align: center\">\r\n                          {{batt_level | number: '1.2'}} %\r\n                        </p>\r\n                            </div>\r\n                <div class=\"col\" (click)=\"AlertChangeStatuts()\">\r\n                            <img src=\"assets/imgs/emergency.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\r\n                            <p style=\"text-align: center\">\r\n                             For help click here !\r\n                           </p>\r\n                </div>\r\n                <div class=\"col\" (click)=\"AlertChangeStatutsOk()\">\r\n                          <img [src]='statusIcon' style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\r\n                          <p style=\"text-align: center\">\r\n                          {{status}}\r\n                          </p>\r\n                </div>\r\n                </div>\r\n  </ion-content>"

/***/ }),

/***/ "./src/app/pages/accountu/accountu.page.scss":
/*!***************************************************!*\
  !*** ./src/app/pages/accountu/accountu.page.scss ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = "* {\n  box-sizing: border-box; }\n\n.col-container {\n  display: table;\n  width: 100%; }\n\n.col {\n  display: table-cell;\n  padding: 16px;\n  margin: 5px;\n  width: 33%; }\n\n@media only screen and (max-width: 200px) {\n  .col {\n    display: block;\n    width: 100%; } }\n\n.col:hover {\n  background: #c71f1f77; }\n\np {\n  font-weight: bold; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/pages/accountu/accountu.page.ts":
/*!*************************************************!*\
  !*** ./src/app/pages/accountu/accountu.page.ts ***!
  \*************************************************/
/*! exports provided: AccountuPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccountuPage", function() { return AccountuPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _services_emergency_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/emergency.service */ "./src/app/services/emergency.service.ts");
...
/* harmony import */ var _services_motion_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../services/motion.service */ "./src/app/services/motion.service.ts");
...
var AccountuPage = /** @class */ (function () {
    function AccountuPage(motionService, alertController, navContrl, emergencyService, locationService, weatherService, authService, sensorService, storage, network, toastCtrl) {
    ...
    AccountuPage.prototype.ngOnInit = function () {
        var _this = this;
        this.verifyConnection();
        var sourcee = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(3599000);
        this.subscriptionn = sourcee.subscribe(function (val) {
            _this.storage.get(REFRESH_TOKEN_KEY).then(function (tokeni) {
                _this.storage.get(TOKEN_KEY).then(function (tokenn) {
                    _this.authService.updateToken("auth", tokeni, tokenn).subscribe(function (resp) {
                        _this.storage.set(TOKEN_KEY, resp["access_token"]);
                    });
                });
            });
        });
        this.watchStability();
        if (!this.token) {
            this.storage.get("access_token").then(function (tokenn) {
                _this.token = tokenn;
                if (!_this.user) {
                    _this.storage.get("User").then(function (userr) {
                        _this.user = userr;
                        _this.getSensorData();
                        _this.getWeather();
                        _this.startNavigating();
                        var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(10000);
                        _this.subscription = source.subscribe(function (val) {
                            if (_this.motionService.alert) {
                                _this.statusIcon = "assets/imgs/alert.png";
                                _this.status = "ALERT !";
                                _this.stat = "ALERTS";
                            }
                            _this.getSensorData();
    ...
    AccountuPage.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
        this.sub.unsubscribe();
        this.disconnectSubscription.unsubscribe();
    };
    AccountuPage.prototype.verifyConnection = function () {
        var _this = this;
    ...
    AccountuPage.prototype.logout = function () {
        this.authService.logout();
    };
    AccountuPage.prototype.getSensorData = function () {
        var _this = this;
        this.sensorService.getApiSensor(this.user.email, this.token).subscribe(function (res) {
            _this.humidity = res[0].humidity;
            _this.temp = res[0].temperature;
            _this.voltage = res[0].voltage;
            _this.current = res[0].current;
            _this.max_v = res[0].max_v;
            _this.min_v = res[0].min_v;
            _this.mAH = res[0].battery_mah;
            _this.batt_level = Number(((Number(_this.voltage) - Number(_this.min_v)) / (Number(_this.max_v) - Number(_this.min_v))) * 100);
            _this.storage.get("distance_m").then(function (dist) {
                _this.home_restTime = (Number(dist) / 1000) / 6.3;
                _this.batt_restTime = _this.mAH * (_this.batt_level / 100) / (Number(_this.current) * 1000);
                if (_this.batt_restTime <= _this.home_restTime) {
                    _this.emergencyService.updateEmergency({ "status": "ALERTB" }, _this.user.email, _this.token).subscribe();
                    _this.status = "ALERT !";
                    _this.stat = "ALERTB";
                    _this.statusIcon = "assets/imgs/alert.png";
                }
                else {
                    if (_this.stat === "ALERTB") {
                        _this.status = "OK !";
                        _this.stat = "OK";
                        _this.statusIcon = "assets/imgs/oki.png";
                        _this.emergencyService.updateEmergency({ "status": "OK" }, _this.user.email, _this.token).subscribe();
                    }
                }
            });
        });
    };
    AccountuPage.prototype.getWeather = function () {
        var _this = this;
        this.locationService.getLocation().then(function (loc) {
            _this.weatherService.getWeather(loc).subscribe(function (resp) {
                _this.weather.city = 'You are at ' + resp.name + ', ' + resp.sys.country;
                _this.weather.description = resp.weather[0].description;
                _this.weather.icon = 'http://openweathermap.org/img/w/' + resp.weather[0].icon + '.png';
                _this.weather.humidity = resp.main.humidity + ' %';
                _this.weather.temperature = resp.main.temp + ' °C';
                var datePipe = new _angular_common__WEBPACK_IMPORTED_MODULE_7__["DatePipe"]("en-US");
                _this.weather.sunRise = datePipe.transform((resp.sys.sunrise * 1000), "hh:mm a");
                _this.weather.sunSet = datePipe.transform((resp.sys.sunset * 1000), "hh:mm a");
                var today = new Date();
                _this.weather.lastUp = Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["formatDate"])(today, 'dd-MM-yyyy hh:mm a', 'en-US');
            });
        });
    };
    AccountuPage.prototype.startNavigating = function () {
        var _this = this;
        var directionsService = new google.maps.DirectionsService;
        this.storage.get("User").then(function (user) {
            _this.locationService.getLocation().then(function (pos) {
                directionsService.route({
                    ...
                    if (status == google.maps.DirectionsStatus.OK) {
                        _this.storage.set("distance_m", res.routes[0].legs[0].distance.value);
                    }
                    else {
                        console.warn(status);
                    }
    ...
    AccountuPage.prototype.openWeather = function () {
        this.navContrl.navigateRoot('/tabs/(weather:weather)');
    };
    AccountuPage.prototype.AlertChangeStatutsOk = function () {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        _this.storage.get("access_token").then(function (tokenn) {
                                            _this.token = tokenn;
                                            _this.storage.get("User").then(function (userr) {
                                                _this.emergencyService.updateEmergency({ "status": "OK" }, _this.user.email, _this.token).subscribe();
                                                _this.statusIcon = "assets/imgs/oki.png";
                                                _this.status = "Ok !";
                                                _this.stat = "OK";
                                                _this.motionService.alert = false;
                                            });
                                        });
                                    }
                                }
    ...
    AccountuPage.prototype.AlertChangeStatuts = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        _this.storage.get("access_token").then(function (tokenn) {
                                            _this.token = tokenn;
                                            _this.storage.get("User").then(function (userr) {
                                                _this.emergencyService.updateEmergency({ "status": "ALERTN" }, _this.user.email, _this.token).subscribe();
                                                _this.statusIcon = "assets/imgs/alert.png";
                                                _this.status = "ALERT !";
                                            });
                                        });
    ...
    AccountuPage.prototype.watchStability = function () {
    ...
    AccountuPage.prototype.presentToast = function (m) {
    ...
    AccountuPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-accountu',
            template: __webpack_require__(/*! ./accountu.page.html */ "./src/app/pages/accountu/accountu.page.html"),
            styles: [__webpack_require__(/*! ./accountu.page.scss */ "./src/app/pages/accountu/accountu.page.scss")],
        }),
        __metadata("design:paramtypes", [_services_motion_service__WEBPACK_IMPORTED_MODULE_10__["MotionService"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_9__["AlertController"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_9__["NavController"],
            _services_emergency_service__WEBPACK_IMPORTED_MODULE_8__["EmergencyService"],
            ...
            _services_sensor_service__WEBPACK_IMPORTED_MODULE_2__["SensorService"],
...
/***/ "./src/app/pages/accountus/accountus.module.ts":
/*!*****************************************************!*\
  !*** ./src/app/pages/accountus/accountus.module.ts ***!
  \*****************************************************/
/*! exports provided: AccountusPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccountusPageModule", function() { return AccountusPageModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _accountus_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./accountus.page */ "./src/app/pages/accountus/accountus.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _accountus_page__WEBPACK_IMPORTED_MODULE_5__["AccountusPage"]
    }
];
var AccountusPageModule = /** @class */ (function () {
    function AccountusPageModule() {
    }
    AccountusPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
            ...
            declarations: [_accountus_page__WEBPACK_IMPORTED_MODULE_5__["AccountusPage"]]
        })
    ], AccountusPageModule);
    return AccountusPageModule;
}());
...
/***/ "./src/app/pages/accountus/accountus.page.html":
/*!*****************************************************!*\
  !*** ./src/app/pages/accountus/accountus.page.html ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n  <ion-toolbar style=\"--background: url(../assets/imgs/background16.jpg);\">\n    <ion-buttons slot=\"start\">\n    </ion-buttons>\n    <ion-title>My Account</ion-title>\n  </ion-toolbar>\n</ion-header>\n \n<ion-content style=\"--background: url(assets/imgs/background16.jpg) center / 100%;\" padding>\n  <div class=\"col-container\" style=\"background: #ffffff40;border-style: solid;border-color: #ffffff40;\">\n      <div class=\"col\" (click)=\"openWeather()\">\n                      <img src=\"assets/imgs/temp.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\n                  <p style=\"text-align: center\">\n                    {{weather.temperature}}\n                  </p>\n      </div>\n    <br>\n          <div class=\"col\" (click)=\"openWeather()\">\n                      <img src=\"assets/imgs/humidity.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\n                      <p style=\"text-align: center\">\n                      {{weather.humidity}}\n                     </p>\n          </div>\n          <div class=\"col\" (click)=\"openWeather()\">\n                    <img [src]='weather.icon' style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\n                    <p style=\"text-align: center\">\n                    {{weather.description}}\n                    </p>\n         </div>\n        </div>\n        <div class=\"col-container\" style=\"background: #ffffff40;border-style: solid;border-color: #ffffff40;\">\n            <div class=\"col\" (click)=\"goMap()\">\n                            <img src=\"assets/imgs/user_position.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\n                        <p style=\"text-align: center\">\n                            Find {{user?.name_u}} !\n                        </p>\n                            </div>\n                <div class=\"col\" (click)=\"makeCall()\">\n                            <img src=\"assets/imgs/call_user.png\" style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\n                            <p style=\"text-align: center\">\n                             Call {{user?.name_u}} !\n                           </p>\n                </div>\n                <div class=\"col\" (click)=\"AlertChangeStatutsOk()\">\n                          <img [src]='statusIcon' style=\"display: block;margin-left: auto;margin-right: auto;width: 70%;\"/>\n                          <p style=\"text-align: center\">\n                          {{status}}\n                          </p>\n                </div>\n                </div>\n  </ion-content>"

/***/ }),

/***/ "./src/app/pages/accountus/accountus.page.scss":
/*!*****************************************************!*\
  !*** ./src/app/pages/accountus/accountus.page.scss ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "* {\n  box-sizing: border-box; }\n\n.col-container {\n  display: table;\n  width: 100%; }\n\n.col {\n  display: table-cell;\n  padding: 16px;\n  margin: 5px;\n  width: 33%; }\n\n@media only screen and (max-width: 200px) {\n  .col {\n    display: block;\n    width: 100%; } }\n\n.col:hover {\n  background: #c71f1f77; }\n\np {\n  font-weight: bold; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/pages/accountus/accountus.page.ts":
/*!***************************************************!*\
  !*** ./src/app/pages/accountus/accountus.page.ts ***!
  \***************************************************/
/*! exports provided: AccountusPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccountusPage", function() { return AccountusPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../services/auth.service */ "./src/app/services/auth.service.ts");
...
/* harmony import */ var _services_emergency_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/emergency.service */ "./src/app/services/emergency.service.ts");
...
/* harmony import */ var _ionic_native_phonegap_local_notification_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/phonegap-local-notification/ngx */ "./node_modules/@ionic-native/phonegap-local-notification/ngx/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TOKEN_KEY = 'access_token';
var REFRESH_TOKEN_KEY = 'refresh_token';
var AccountusPage = /** @class */ (function () {
    function AccountusPage(alertController, navContrl, emergencyService, locationService, weatherService, authService, storage, network, toastCtrl, callNumber, localNotification) {
        this.alertController = alertController;
        this.navContrl = navContrl;
        this.emergencyService = emergencyService;
        this.locationService = locationService;
    ...
    AccountusPage.prototype.ngOnInit = function () {
        var _this = this;
        this.verifyConnection();
        var sourcee = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(3599000);
        this.subscriptionn = sourcee.subscribe(function (val) {
            _this.storage.get(REFRESH_TOKEN_KEY).then(function (tokeni) {
                _this.storage.get(TOKEN_KEY).then(function (tokenn) {
                    _this.authService.updateToken("auths", tokeni, tokenn).subscribe(function (resp) {
                        _this.storage.set(TOKEN_KEY, resp["access_token"]);
                    });
                });
            });
    ...
    AccountusPage.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
        this.subscriptionn.unsubscribe();
        this.disconnectSubscription.unsubscribe();
    };
    AccountusPage.prototype.verifyConnection = function () {
        var _this = this;
        this.disconnectSubscription = this.network.onDisconnect().subscribe(function () {
            _this.presentToast("Please turn on your connection !");
        });
    };
    AccountusPage.prototype.logout = function () {
        this.authService.logout();
    };
    AccountusPage.prototype.getWeather = function () {
        var _this = this;
        this.locationService.getLocation().then(function (loc) {
            _this.weatherService.getWeather(loc).subscribe(function (resp) {
                _this.weather.city = 'You are at ' + resp.name + ', ' + resp.sys.country;
                ...
                _this.weather.sunSet = datePipe.transform((resp.sys.sunset * 1000), "hh:mm a");
                var today = new Date();
                _this.weather.lastUp = Object(_angular_common__WEBPACK_IMPORTED_MODULE_6__["formatDate"])(today, 'dd-MM-yyyy hh:mm a', 'en-US');
            });
        });
    };
    AccountusPage.prototype.openWeather = function () {
        this.navContrl.navigateRoot('/tabss/(weather:weather)');
    };
    AccountusPage.prototype.goMap = function () {
        this.navContrl.navigateRoot('/tabss/(maps:maps)');
    };
    AccountusPage.prototype.getEmergency = function () {
        var _this = this;
        this.emergencyService.getApiEmergency(this.user.email_u, this.token).subscribe(function (result) {
            if (result[0].status === "ALERTS") {
                _this.status = _this.user.name_u + " loses stability !";
                _this.statusIcon = "assets/imgs/alert.png";
                _this.sugset = "You may find him with map !";
                _this.showNotification();
            }
            else if (result[0].status === "ALERTN") {
                _this.status = _this.user.name_u + " need your help !";
                _this.statusIcon = "assets/imgs/alert.png";
                _this.sugset = "You may call him !";
                _this.showNotification();
            }
            else if (result[0].status === "ALERTB") {
                _this.status = _this.user.name_u + " is losing energy !";
                _this.statusIcon = "assets/imgs/alert.png";
                _this.sugset = "You may call him !";
                _this.showNotification();
            }
    ...
    AccountusPage.prototype.presentToast = function (m) {
        var toast = this.toastCtrl.create({
            message: m,
            duration: 1500,
            position: 'bottom'
    ...
    AccountusPage.prototype.makeCall = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                    ...
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    text: 'OK',
                                    handler: function () {
                                        _this.callNumber.callNumber(_this.user.phone_u, true)
                                            .then(function (res) { return _this.presentToast('Launched dialer!'); })
                                            .catch(function (err) { return _this.presentToast('Error launching dialer'); });
                                    }
                                }
                            ]
                        })];
    ...
    //here modify
    AccountusPage.prototype.showNotification = function () {
        var _this = this;
        this.localNotification.requestPermission().then(function (permission) {
            if (permission === 'granted') {
                // Create the notification
                _this.localNotification.create('ALERT !', {
                    tag: _this.user.name_u + 'need your help !',
                    body: _this.sugset,
    ...
    AccountusPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-accountus',
            template: __webpack_require__(/*! ./accountus.page.html */ "./src/app/pages/accountus/accountus.page.html"),
            styles: [__webpack_require__(/*! ./accountus.page.scss */ "./src/app/pages/accountus/accountus.page.scss")],
        }),
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_8__["AlertController"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["NavController"],
            _services_emergency_service__WEBPACK_IMPORTED_MODULE_7__["EmergencyService"],
            _services_location_service__WEBPACK_IMPORTED_MODULE_5__["LocationService"],
            _services_weather_service__WEBPACK_IMPORTED_MODULE_4__["WeatherService"],
            _services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"],
            ...
            _ionic_native_phonegap_local_notification_ngx__WEBPACK_IMPORTED_MODULE_11__["PhonegapLocalNotification"]])
    ], AccountusPage);
    return AccountusPage;
}());
...
module.exports = "<ion-header>\r\n  <ion-toolbar style=\"--background: url(../assets/imgs/background16.jpg);\">\r\n    <ion-buttons slot=\"start\">\r\n      <ion-menu-button></ion-menu-button>\r\n    </ion-buttons>\r\n    <ion-title>Map</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n \r\n<ion-content style=\"--background: url(assets/imgs/background16.jpg) center / 100%;\">\r\n  <div #map id=\"map\" style=\"height: 105%;width: 100%\"></div>\r\n </ion-content>"
...
var MapPage = /** @class */ (function () {
    function MapPage(locationService, storage, geolocation, plt) {
        this.locationService = locationService;
        this.storage = storage;
        this.geolocation = geolocation;
        this.plt = plt;
        this.distanceView = "Loading ...";
    }
    MapPage.prototype.ngOnInit = function () {
        var _this = this;
        this.ionViewDidLoad();
        this.startNavigating();
        var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["interval"])(20000);
        this.subscription = source.subscribe(function (val) { return _this.startNavigating(); });
    };
    ...
    MapPage = __decorate([
        ...
        __metadata("design:paramtypes", [_services_location_service__WEBPACK_IMPORTED_MODULE_4__["LocationService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_1__["Geolocation"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"]])
    ], MapPage);
    return MapPage;
}());
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _maps_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./maps.page */ "./src/app/pages/maps/maps.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "./src/app/pages/maps/maps.page.html":
/*!*******************************************!*\
  !*** ./src/app/pages/maps/maps.page.html ***!
  \*******************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL21hcHMvbWFwcy5wYWdlLnNjc3MifQ== */"
...
var MapsPage = /** @class */ (function () {
    function MapsPage(locationService, storage, geolocation, plt) {
        this.locationService = locationService;
        this.storage = storage;
        this.geolocation = geolocation;
        this.plt = plt;
    ...
    MapsPage.prototype.startNavigating = function () {
        ...
        this.geolocation.getCurrentPosition().then(function (pos) {
            directionsDisplay.setMap(_this.map);
            _this.locationService.getApiLocation(_this.user.email_u, _this.token).subscribe(function (posu) {
                directionsService.route({
                    origin: { lat: pos.coords.latitude, lng: pos.coords.longitude },
    ...
    MapsPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-maps',
            template: __webpack_require__(/*! ./maps.page.html */ "./src/app/pages/maps/maps.page.html"),
            styles: [__webpack_require__(/*! ./maps.page.scss */ "./src/app/pages/maps/maps.page.scss")],
        }),
        __metadata("design:paramtypes", [_services_location_service__WEBPACK_IMPORTED_MODULE_4__["LocationService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_1__["Geolocation"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"]])
    ], MapsPage);
    return MapsPage;
...
module.exports = "<ion-header>\r\n  <ion-toolbar style=\"--background: url(../assets/imgs/background16.jpg);\">\r\n    <ion-buttons slot=\"start\">\r\n      <ion-menu-button></ion-menu-button>\r\n    </ion-buttons>\r\n    <ion-title>Settings</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n \r\n<ion-content style=\"--background: url(assets/imgs/background16.jpg) center / 100%;\" >\r\n<ion-list style=\"background: #ffffff00;\">\r\n  <ion-item (click)=\"ChangeAccountU()\" class=\"onclick\" style=\"background: #47464740;\" >\r\n    <ion-icon slot=\"start\" name=\"person\"></ion-icon>\r\n    <ion-label>Modify User</ion-label>\r\n  </ion-item>\r\n  <ion-item (click)=\"ChangePasswordU()\" class=\"onclick\">\r\n    <ion-icon slot=\"start\" name=\"lock\"></ion-icon>\r\n    <ion-label>Modify Password</ion-label>\r\n  </ion-item>\r\n  <ion-item (click)=\"ChangeSupervisorU()\" class=\"onclick\" style=\"background: #47464740;\" >\r\n    <ion-icon slot=\"start\" name=\"contact\"></ion-icon>\r\n    <ion-label>Modify Supervisor</ion-label>\r\n  </ion-item>\r\n  <ion-item (click)=\"locationChangeConfirm()\" class=\"onclick\">\r\n    <ion-icon slot=\"start\" name=\"pin\"></ion-icon>\r\n    <ion-label>Modify Home Location</ion-label>\r\n  </ion-item>\r\n</ion-list> \r\n</ion-content>"
...
module.exports = ".onclick:hover {\n  background: #c71f1f77; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/auth.service */ "./src/app/services/auth.service.ts");
/* harmony import */ var _services_emergency_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/emergency.service */ "./src/app/services/emergency.service.ts");
/* harmony import */ var _services_location_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../services/location.service */ "./src/app/services/location.service.ts");
/* harmony import */ var _services_sensor_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/sensor.service */ "./src/app/services/sensor.service.ts");
/* harmony import */ var _services_supervisor_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/supervisor.service */ "./src/app/services/supervisor.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(toastCtrl, authService, alertController, storage, userService, emergencyService, locationService, sensorService, supervisorService) {
        this.toastCtrl = toastCtrl;
        this.authService = authService;
        this.alertController = alertController;
        this.storage = storage;
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        for (var _i = 0, _a = Object.keys(data); _i < _a.length; _i++) {
                                            var item = _a[_i];
                                            if (!data[item]) {
                                                _this.datan[item] = _this.user[item];
                                            }
                                            else {
                                                _this.datan[item] = data[item];
                                            }
                                        }
                                        var datta = {};
                                        datta["name_u"] = _this.datan.fullName;
                                        datta["email_u"] = _this.datan.email;
                                        datta["phone_u"] = _this.datan.phone;
                                        _this.userService.updateUser(_this.datan, _this.user.email, _this.token).subscribe(function (res) {
                                            _this.locationService.updateLocation(_this.datan, _this.user.email, _this.token).subscribe(function (res) {
                                                _this.emergencyService.updateEmergency(_this.datan, _this.user.email, _this.token).subscribe(function (res) {
                                                    _this.sensorService.updateSensor(_this.datan, _this.user.email, _this.token).subscribe(function (res) {
                                                        _this.supervisorService.updateSupervisor(datta, _this.user.email_s, _this.token).subscribe(function (res) {
                                                            _this.logout();
                                                        });
                                                    });
                                                });
    ...
    SettingsPage.prototype.ChangePasswordU = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        if (!data["password"] || data["cpassword"] != data["password"] || data["password"].length < 6) {
                                            _this.showAlert("Enter password again !!");
                                        }
                                        else {
                                            _this.userService.updateUser(data, _this.user.email, _this.token).subscribe(function (res) { return _this.logout(); });
                                        }
                                    }
                                }
                            ]
    ...
    SettingsPage.prototype.ChangeSupervisorU = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        if (!data["fullName"] || !data["email"] || !data["phone"] || !data["password"]) {
                                            ...
                                            data["name_u"] = _this.user.fullName;
                                            data["email_u"] = _this.user.email;
                                            data["phone_u"] = _this.user.phone;
                                            _this.supervisorService.deleteSupervisor(_this.user.email_s, _this.token).subscribe(function (res) {
                                                _this.authService.registerS(data).subscribe(function (res) {
                                                    _this.userService.updateUser(datta, _this.user.email, _this.token).subscribe(function (res) {
                                                        _this.logout();
                                                    });
                                                });
                                            });
    ...
    SettingsPage.prototype.showAlert = function (msg) {
    ...
    SettingsPage.prototype.locationChangeConfirm = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                    ...
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    text: 'Save',
                                    handler: function () {
                                        _this.locationService.getLocation().then(function (result) {
                                            _this.userService.updateUser(result, _this.user.email, _this.token).subscribe(function (result) { return _this.presentToast("Location updated !"); });
                                        });
                                    }
                                }
                            ]
    ...
    SettingsPage.prototype.presentToast = function (m) {
        var toast = this.toastCtrl.create({
            message: m,
            duration: 1500,
            position: 'bottom'
    ...
    SettingsPage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ToastController"], _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"], _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _services_emergency_service__WEBPACK_IMPORTED_MODULE_5__["EmergencyService"], _services_location_service__WEBPACK_IMPORTED_MODULE_6__["LocationService"], _services_sensor_service__WEBPACK_IMPORTED_MODULE_7__["SensorService"], _services_supervisor_service__WEBPACK_IMPORTED_MODULE_8__["SupervisorService"]])
    ], SettingsPage);
    return SettingsPage;
}());
...
/***/ "./src/app/pages/settingss/settingss.module.ts":
/*!*****************************************************!*\
  !*** ./src/app/pages/settingss/settingss.module.ts ***!
  \*****************************************************/
/*! exports provided: SettingssPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SettingssPageModule", function() { return SettingssPageModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _settingss_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./settingss.page */ "./src/app/pages/settingss/settingss.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _settingss_page__WEBPACK_IMPORTED_MODULE_5__["SettingssPage"]
    }
];
var SettingssPageModule = /** @class */ (function () {
    function SettingssPageModule() {
    }
    SettingssPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
            ...
            declarations: [_settingss_page__WEBPACK_IMPORTED_MODULE_5__["SettingssPage"]]
        })
    ], SettingssPageModule);
    return SettingssPageModule;
}());
...
/***/ "./src/app/pages/settingss/settingss.page.html":
/*!*****************************************************!*\
  !*** ./src/app/pages/settingss/settingss.page.html ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n    <ion-toolbar style=\"--background: url(../assets/imgs/background16.jpg);\">\n      <ion-buttons slot=\"start\">\n      </ion-buttons>\n      <ion-title>Settings</ion-title>\n    </ion-toolbar>\n  </ion-header>\n   \n  <ion-content style=\"--background: url(assets/imgs/background16.jpg) center / 100%;\" >\n  <ion-list style=\"background: #ffffff00;\">\n    <ion-item (click)=\"ChangeAccountS()\" class=\"onclick\" style=\"background: #47464740;\" >\n      <ion-icon slot=\"start\" name=\"person\"></ion-icon>\n      <ion-label>Modify Supervisor</ion-label>\n    </ion-item>\n    <ion-item (click)=\"ChangePasswordS()\" class=\"onclick\">\n      <ion-icon slot=\"start\" name=\"lock\"></ion-icon>\n      <ion-label>Modify Password</ion-label>\n    </ion-item>\n  </ion-list> \n  </ion-content>"

/***/ }),

/***/ "./src/app/pages/settingss/settingss.page.scss":
/*!*****************************************************!*\
  !*** ./src/app/pages/settingss/settingss.page.scss ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = ".onclick:hover {\n  background: #c71f1f77; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/pages/settingss/settingss.page.ts":
/*!***************************************************!*\
  !*** ./src/app/pages/settingss/settingss.page.ts ***!
  \***************************************************/
/*! exports provided: SettingssPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SettingssPage", function() { return SettingssPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/storage */ "./node_modules/@ionic/storage/fesm5/ionic-storage.js");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/user.service */ "./src/app/services/user.service.ts");
...
var SettingssPage = /** @class */ (function () {
    function SettingssPage(toastCtrl, authService, alertController, storage, userService, emergencyService, locationService, sensorService, supervisorService) {
        this.toastCtrl = toastCtrl;
        this.authService = authService;
        this.alertController = alertController;
        this.storage = storage;
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        var datta = {};
                                        datta["name_s"] = _this.datan.fullName;
                                        datta["email_s"] = _this.datan.email;
                                        datta["phone_s"] = _this.datan.phone;
                                        _this.userService.updateUser(datta, _this.user.email_u, _this.token).subscribe(function (res) {
                                            _this.supervisorService.updateSupervisor(_this.datan, _this.user.email, _this.token).subscribe(function (res) {
                                                _this.logout();
                                            });
                                        });
                                    }
    ...
    SettingssPage.prototype.ChangePasswordS = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        if (!data["password"] || data["cpassword"] != data["password"] || data["password"].length < 6) {
                                            ...
                                            _this.supervisorService.updateSupervisor(data, _this.user.email, _this.token).subscribe(function (res) { return _this.logout(); });
                                        }
                                    }
                                }
                            ]
    ...
    SettingssPage.prototype.logout = function () {
        this.authService.logout();
    };
    SettingssPage.prototype.showAlert = function (msg) {
        var alert = this.alertController.create({
            message: msg,
            header: 'Error',
            buttons: ['OK']
    ...
    SettingssPage.prototype.presentToast = function (m) {
        var toast = this.toastCtrl.create({
            message: m,
            duration: 1500,
            position: 'bottom'
    ...
    SettingssPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-settingss',
            template: __webpack_require__(/*! ./settingss.page.html */ "./src/app/pages/settingss/settingss.page.html"),
            styles: [__webpack_require__(/*! ./settingss.page.scss */ "./src/app/pages/settingss/settingss.page.scss")],
        }),
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ToastController"], _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"], _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _services_emergency_service__WEBPACK_IMPORTED_MODULE_5__["EmergencyService"], _services_location_service__WEBPACK_IMPORTED_MODULE_6__["LocationService"], _services_sensor_service__WEBPACK_IMPORTED_MODULE_7__["SensorService"], _services_supervisor_service__WEBPACK_IMPORTED_MODULE_8__["SupervisorService"]])
    ], SettingssPage);
    return SettingssPage;
}());
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _weather_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./weather.page */ "./src/app/pages/weather/weather.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _weather_page__WEBPACK_IMPORTED_MODULE_5__["WeatherPage"]
    }
];
var WeatherPageModule = /** @class */ (function () {
    ...
    WeatherPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_weather_page__WEBPACK_IMPORTED_MODULE_5__["WeatherPage"]]
        })
    ], WeatherPageModule);
...
/***/ "./src/app/pages/weather/weather.page.html":
/*!*************************************************!*\
  !*** ./src/app/pages/weather/weather.page.html ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\r\n  <ion-toolbar style=\"--background: url(../assets/imgs/background16.jpg);\">\r\n    <ion-buttons slot=\"start\">\r\n      <ion-menu-button></ion-menu-button>\r\n    </ion-buttons>\r\n    <ion-title>Weather</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n \r\n<ion-content style=\"--background: url(assets/imgs/background16.jpg) center / 100%;\" padding>\r\n  <ion-grid style=\"background: #ffffff40;border-style: solid;border-color: #ffffff40;\">\r\n      <ion-row>\r\n          <ion-col>\r\n              <p style=\"text-align: center;font-weight: bold;font-size: 20px\">\r\n              {{weather.city}}\r\n              </p>\r\n            </ion-col>\r\n      </ion-row>\r\n      <ion-row>\r\n          <ion-col>\r\n              <p style=\"text-align: center;font-weight: bold;font-size: 20px\">\r\n              {{weather.lastUp}}\r\n              </p>\r\n            </ion-col>\r\n      </ion-row>\r\n      <ion-row>\r\n        <ion-col>\r\n        <img [src]='weather.icon' style=\"display: block;margin-left: auto;margin-right: auto;width: 30%;\"/>\r\n        <p style=\"text-align: center;font-weight: bold;font-size: 20px\">\r\n        {{weather.description}}\r\n        </p>\r\n      </ion-col>\r\n      </ion-row>\r\n      <ion-row>\r\n          <ion-col>\r\n              <p style=\"text-align: center;font-weight: bold;font-size: 20px\">\r\n              {{weather.temperature}}\r\n              </p>\r\n            </ion-col>\r\n      </ion-row>\r\n      <ion-row>\r\n          <ion-col>\r\n              <p style=\"text-align: center;font-weight: bold;font-size: 20px\">\r\n              {{weather.humidity}}\r\n              </p>\r\n            </ion-col>\r\n      </ion-row>\r\n      <ion-row>\r\n          <ion-col>\r\n              <p style=\"text-align: center;font-weight: bold;font-size: 20px\">\r\n              {{weather.sunRise}}\r\n              </p>\r\n            </ion-col>\r\n      </ion-row>\r\n      <ion-row>\r\n          <ion-col>\r\n              <p style=\"text-align: center;font-weight: bold;font-size: 20px\">\r\n              {{weather.sunSet}}\r\n              </p>\r\n            </ion-col>\r\n      </ion-row>\r\n\r\n  </ion-grid>\r\n\r\n \r\n</ion-content>"

/***/ }),

/***/ "./src/app/pages/weather/weather.page.scss":
/*!*************************************************!*\
  !*** ./src/app/pages/weather/weather.page.scss ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3dlYXRoZXIvd2VhdGhlci5wYWdlLnNjc3MifQ== */"
...
var WeatherPage = /** @class */ (function () {
    function WeatherPage(locationService, weatherService) {
        this.locationService = locationService;
        this.weatherService = weatherService;
        this.weather = {
            city: '',
    ...
    WeatherPage.prototype.getWeather = function () {
        ...
        this.locationService.getLocation().then(function (loc) {
            _this.weatherService.getWeather(loc).subscribe(function (resp) {
                ...
                _this.weather.description = resp.weather[0].description;
                _this.weather.icon = 'http://openweathermap.org/img/w/' + resp.weather[0].icon + '.png';
                _this.weather.humidity = 'Humidity: ' + resp.main.humidity + ' %';
                _this.weather.temperature = 'Temperature: ' + resp.main.temp + ' °C';
                var datePipe = new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"]("en-US");
                _this.weather.sunRise = 'Sunrise: ' + String(datePipe.transform((resp.sys.sunrise * 1000), "hh:mm a"));
                _this.weather.sunSet = 'Sunset: ' + String(datePipe.transform((resp.sys.sunset * 1000), "hh:mm a"));
                var today = new Date();
                _this.weather.lastUp = 'Last Updated: ' + String(Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(today, 'dd-MM-yyyy hh:mm a', 'en-US'));
            });
        });
    };
    WeatherPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./weather.page.html */ "./src/app/pages/weather/weather.page.html"),
            styles: [__webpack_require__(/*! ./weather.page.scss */ "./src/app/pages/weather/weather.page.scss")],
        }),
        __metadata("design:paramtypes", [_services_location_service__WEBPACK_IMPORTED_MODULE_1__["LocationService"], _services_weather_service__WEBPACK_IMPORTED_MODULE_2__["WeatherService"]])
    ], WeatherPage);
    return WeatherPage;
}());
...
/***/ "./src/app/pages/weathers/weathers.module.ts":
/*!***************************************************!*\
  !*** ./src/app/pages/weathers/weathers.module.ts ***!
  \***************************************************/
/*! exports provided: WeathersPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WeathersPageModule", function() { return WeathersPageModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _weathers_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./weathers.page */ "./src/app/pages/weathers/weathers.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _weathers_page__WEBPACK_IMPORTED_MODULE_5__["WeathersPage"]
    }
];
var WeathersPageModule = /** @class */ (function () {
    function WeathersPageModule() {
    }
    WeathersPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
            ...
            declarations: [_weathers_page__WEBPACK_IMPORTED_MODULE_5__["WeathersPage"]]
        })
    ], WeathersPageModule);
    return WeathersPageModule;
}());
...
/***/ "./src/app/pages/weathers/weathers.page.html":
/*!***************************************************!*\
  !*** ./src/app/pages/weathers/weathers.page.html ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/pages/weathers/weathers.page.scss":
/*!***************************************************!*\
  !*** ./src/app/pages/weathers/weathers.page.scss ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3dlYXRoZXJzL3dlYXRoZXJzLnBhZ2Uuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/pages/weathers/weathers.page.ts":
/*!*************************************************!*\
  !*** ./src/app/pages/weathers/weathers.page.ts ***!
  \*************************************************/
/*! exports provided: WeathersPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WeathersPage", function() { return WeathersPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_location_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/location.service */ "./src/app/services/location.service.ts");
/* harmony import */ var _services_weather_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/weather.service */ "./src/app/services/weather.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
...
var WeathersPage = /** @class */ (function () {
    function WeathersPage(locationService, weatherService) {
        this.locationService = locationService;
        this.weatherService = weatherService;
        this.weather = {
            city: '',
    ...
    WeathersPage.prototype.ngOnInit = function () {
        this.getWeather();
    };
    WeathersPage.prototype.getWeather = function () {
        var _this = this;
        this.locationService.getLocation().then(function (loc) {
            _this.weatherService.getWeather(loc).subscribe(function (resp) {
                _this.weather.city = 'You are at ' + resp.name + ', ' + resp.sys.country;
    ...
    WeathersPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-weathers',
            template: __webpack_require__(/*! ./weathers.page.html */ "./src/app/pages/weathers/weathers.page.html"),
            styles: [__webpack_require__(/*! ./weathers.page.scss */ "./src/app/pages/weathers/weathers.page.scss")],
        }),
        __metadata("design:paramtypes", [_services_location_service__WEBPACK_IMPORTED_MODULE_1__["LocationService"], _services_weather_service__WEBPACK_IMPORTED_MODULE_2__["WeatherService"]])
    ], WeathersPage);
    return WeathersPage;
...
var AuthService = /** @class */ (function () {
    function AuthService(http, helper, storage, plt, alertController, navcrtl) {
        ...
        this.accountType = new rxjs__WEBPACK_IMPORTED_MODULE_7__["BehaviorSubject"](false);
        this.plt.ready().then(function () {
            _this.checkToken();
        });
    }
        ...
        this.storage.get(TOKEN_KEY).then(function (token) {
            if (token) {
                ...
                if (!isExpired) {
                    ...
                    if (_this.user.stype === "Supervisor") {
    ...
    //Verify Token
    AuthService.prototype.updateToken = function (adress, tokeni, tokenn) {
        var httpOptions = {
        ...
        return this.http.post(this.url + "/" + adress + "/refresh", data, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (e) {
            throw new Error(e);
        }));
    };
    //register User
    ...
    //login Supervisor
    AuthService.prototype.loginS = function (credentials) {
        var _this = this;
...
/*!***********************************************!*\
  !*** ./src/app/services/emergency.service.ts ***!
  \***********************************************/
/*! exports provided: EmergencyService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmergencyService", function() { return EmergencyService; });
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @auth0/angular-jwt */ "./node_modules/@auth0/angular-jwt/index.js");
...
var EmergencyService = /** @class */ (function () {
    function EmergencyService(authService, http, alertController, helper, storage) {
        this.authService = authService;
        this.http = http;
        this.alertController = alertController;
        this.helper = helper;
    ...
    //show alert
    EmergencyService.prototype.showAlert = function (msg) {
        var alert = this.alertController.create({
            message: msg,
            header: 'Error',
            buttons: ['OK']
    ...
    EmergencyService = __decorate([
        ...
        __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _ionic_angular__WEBPACK_IMPORTED_MODULE_0__["AlertController"],
            _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_3__["JwtHelperService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"]])
    ], EmergencyService);
...
/* harmony import */ var _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ionic-native/geolocation/ngx */ "./node_modules/@ionic-native/geolocation/ngx/index.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
...
var LocationService = /** @class */ (function () {
    function LocationService(geo, authService, http, alertController, helper, storage) {
        this.geo = geo;
        this.authService = authService;
        this.http = http;
        this.alertController = alertController;
    ...
    LocationService.prototype.getLocation = function () {
        ...
        return this.geo.getCurrentPosition(options).then(function (pos) {
    ...
    //show alert
    LocationService.prototype.showAlert = function (msg) {
        var alert = this.alertController.create({
            message: msg,
            header: 'Error',
            buttons: ['OK']
    ...
    LocationService = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_0__["Geolocation"], _auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"],
            _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_4__["JwtHelperService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"]])
    ], LocationService);
...
/***/ "./src/app/services/motion.service.ts":
/*!********************************************!*\
  !*** ./src/app/services/motion.service.ts ***!
  \********************************************/
/*! exports provided: MotionService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MotionService", function() { return MotionService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_native_device_motion_ngx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic-native/device-motion/ngx */ "./node_modules/@ionic-native/device-motion/ngx/index.js");
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/storage */ "./node_modules/@ionic/storage/fesm5/ionic-storage.js");
/* harmony import */ var _emergency_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emergency.service */ "./src/app/services/emergency.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MotionService = /** @class */ (function () {
    function MotionService(emergencyService, deviceMotion, storage) {
        this.emergencyService = emergencyService;
        this.deviceMotion = deviceMotion;
        this.storage = storage;
        this.alert = false;
    }
    MotionService.prototype.getMotion = function () {
        var _this = this;
        var subscription = this.deviceMotion.watchAcceleration().subscribe(function (acceleration) {
            _this.storage.get("motion").then(function (motion) {
                if (((Number(motion.x) - acceleration.x) >= 3) || ((Number(motion.y) - acceleration.y) >= 3) || ((Number(motion.z) - acceleration.z) >= 3) && !_this.alert) {
                    _this.alert = true;
                    _this.storage.get("access_token").then(function (token) {
                        _this.storage.get("User").then(function (user) {
                            _this.emergencyService.updateEmergency({ "status": "ALERTS" }, user.email, token).subscribe();
                        });
                    });
                }
                else {
                    _this.storage.set("motion", { "x": acceleration.x, "y": acceleration.y, "z": acceleration.z });
                }
            });
        });
        return subscription;
    };
    MotionService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_emergency_service__WEBPACK_IMPORTED_MODULE_3__["EmergencyService"], _ionic_native_device_motion_ngx__WEBPACK_IMPORTED_MODULE_1__["DeviceMotion"], _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])
    ], MotionService);
...
var SensorService = /** @class */ (function () {
    function SensorService(authService, http, alertController, helper, storage) {
        this.authService = authService;
        this.http = http;
        this.alertController = alertController;
        this.helper = helper;
    ...
    //show alert
    SensorService.prototype.showAlert = function (msg) {
        var alert = this.alertController.create({
            message: msg,
            header: 'Error',
            buttons: ['OK']
...
/***/ "./src/app/services/supervisor.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/supervisor.service.ts ***!
  \************************************************/
...
var SupervisorService = /** @class */ (function () {
    function SupervisorService(authService, http, alertController, helper, storage) {
        this.authService = authService;
        this.http = http;
        this.alertController = alertController;
        this.helper = helper;
    ...
    //show alert
    SupervisorService.prototype.showAlert = function (msg) {
        var alert = this.alertController.create({
            message: msg,
            header: 'Error',
            buttons: ['OK']
...
var UserService = /** @class */ (function () {
    function UserService(authService, http, alertController, helper, storage) {
        this.authService = authService;
        this.http = http;
        this.alertController = alertController;
        this.helper = helper;
...
var WeatherService = /** @class */ (function () {
    function WeatherService(http, locationService) {
        this.http = http;
        this.locationService = locationService;
        this.weather_url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].weather_url;
        this.weather_api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_weather;
    }
    WeatherService.prototype.getWeather = function (location) {
        ...
        return this.http.get("" + final_url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) {
            throw new Error(e);
        }));
    };
    WeatherService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _location_service__WEBPACK_IMPORTED_MODULE_2__["LocationService"]])
    ], WeatherService);
...
/* harmony import */ var _pages_accountu_accountu_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../pages/accountu/accountu.page */ "./src/app/pages/accountu/accountu.page.ts");
/* harmony import */ var _pages_map_map_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pages/map/map.page */ "./src/app/pages/map/map.page.ts");
/* harmony import */ var _pages_weather_weather_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../pages/weather/weather.page */ "./src/app/pages/weather/weather.page.ts");
/* harmony import */ var _pages_settings_settings_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../pages/settings/settings.page */ "./src/app/pages/settings/settings.page.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            },
            {
                path: 'accountu',
                outlet: 'accountu',
                component: _pages_accountu_accountu_page__WEBPACK_IMPORTED_MODULE_3__["AccountuPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            },
            {
                path: 'map',
                outlet: 'map',
                component: _pages_map_map_page__WEBPACK_IMPORTED_MODULE_4__["MapPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            },
            {
                path: 'weather',
                outlet: 'weather',
                component: _pages_weather_weather_page__WEBPACK_IMPORTED_MODULE_5__["WeatherPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            },
            {
                path: 'settings',
                outlet: 'settings',
                component: _pages_settings_settings_page__WEBPACK_IMPORTED_MODULE_6__["SettingsPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            }
        ]
    },
...
module.exports = "<ion-tabs>\r\n \r\n  <ion-tab-bar slot=\"bottom\">\r\n    <ion-tab-button tab=\"accountu\" href=\"/tabs/(accountu:accountu)\">\r\n      <ion-icon name=\"person\"></ion-icon>\r\n      <ion-label>Account</ion-label>\r\n    </ion-tab-button>\r\n\r\n    <ion-tab-button tab=\"map\"  href=\"/tabs/(map:map)\" (click)=\"tab2Selected()\">\r\n      <ion-icon name=\"map\"></ion-icon>\r\n      <ion-label>Map</ion-label>\r\n    </ion-tab-button>\r\n\r\n    <ion-tab-button tab=\"weather\"  href=\"/tabs/(weather:weather)\" (click)=\"tab2Selected()\">\r\n      <ion-icon name=\"sunny\"></ion-icon>\r\n      <ion-label>Weather</ion-label>\r\n    </ion-tab-button>\r\n\r\n    <ion-tab-button tab=\"settings\"  href=\"/tabs/(settings:settings)\" (click)=\"tab2Selected()\">\r\n      <ion-icon name=\"settings\"></ion-icon>\r\n      <ion-label>Settings</ion-label>\r\n    </ion-tab-button>\r\n\r\n    <ion-tab-button tab=\"logout\" (click)=\"logout()\">\r\n      <ion-icon name=\"log-out\"></ion-icon>\r\n      <ion-label>Logout</ion-label>\r\n    </ion-tab-button>\r\n\r\n  </ion-tab-bar>\r\n\r\n  <ion-tab tab=\"accountu\">\r\n    <ion-router-outlet name=\"accountu\"></ion-router-outlet>\r\n  </ion-tab>\r\n\r\n  <ion-tab tab=\"map\">\r\n    <ion-router-outlet name=\"map\"></ion-router-outlet>\r\n  </ion-tab>\r\n\r\n  <ion-tab tab=\"weather\">\r\n    <ion-router-outlet name=\"weather\"></ion-router-outlet>\r\n  </ion-tab>\r\n\r\n  <ion-tab tab=\"settings\">\r\n    <ion-router-outlet name=\"settings\"></ion-router-outlet>\r\n  </ion-tab>\r\n  \r\n</ion-tabs>\r\n"
...
var TabsComponent = /** @class */ (function () {
    ...
    TabsComponent.prototype.tab2Selected = function () {
...
/* harmony import */ var _pages_accountu_accountu_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pages/accountu/accountu.module */ "./src/app/pages/accountu/accountu.module.ts");
...
/* harmony import */ var _pages_map_map_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../pages/map/map.module */ "./src/app/pages/map/map.module.ts");
/* harmony import */ var _pages_weather_weather_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../pages/weather/weather.module */ "./src/app/pages/weather/weather.module.ts");
    ...
    TabsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _pages_accountu_accountu_module__WEBPACK_IMPORTED_MODULE_4__["AccountuPageModule"],
                _pages_map_map_module__WEBPACK_IMPORTED_MODULE_6__["MapPageModule"],
                _pages_weather_weather_module__WEBPACK_IMPORTED_MODULE_7__["WeatherPageModule"],
                _pages_settings_settings_module__WEBPACK_IMPORTED_MODULE_8__["SettingsPageModule"]
            ],
...
/***/ "./src/app/tabss/tabss-routing.module.ts":
/*!***********************************************!*\
  !*** ./src/app/tabss/tabss-routing.module.ts ***!
  \***********************************************/
/*! exports provided: TabssRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabssRoutingModule", function() { return TabssRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _tabss_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tabss.component */ "./src/app/tabss/tabss.component.ts");
/* harmony import */ var _pages_accountus_accountus_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../pages/accountus/accountus.page */ "./src/app/pages/accountus/accountus.page.ts");
/* harmony import */ var _pages_maps_maps_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pages/maps/maps.page */ "./src/app/pages/maps/maps.page.ts");
/* harmony import */ var _pages_weathers_weathers_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../pages/weathers/weathers.page */ "./src/app/pages/weathers/weathers.page.ts");
/* harmony import */ var _pages_settingss_settingss_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../pages/settingss/settingss.page */ "./src/app/pages/settingss/settingss.page.ts");
/* harmony import */ var _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../services/auth-guard.service */ "./src/app/services/auth-guard.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var routes = [
    {
        path: 'tabss',
        component: _tabss_component__WEBPACK_IMPORTED_MODULE_2__["TabssComponent"],
        children: [
            {
                path: '',
            ...
            },
            {
                path: 'accountus',
                outlet: 'accountus',
                component: _pages_accountus_accountus_page__WEBPACK_IMPORTED_MODULE_3__["AccountusPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            },
            {
                path: 'maps',
                outlet: 'maps',
                component: _pages_maps_maps_page__WEBPACK_IMPORTED_MODULE_4__["MapsPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            },
            {
                path: 'weathers',
                outlet: 'weathers',
                component: _pages_weathers_weathers_page__WEBPACK_IMPORTED_MODULE_5__["WeathersPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            },
            {
                path: 'settingss',
                outlet: 'settingss',
                component: _pages_settingss_settingss_page__WEBPACK_IMPORTED_MODULE_6__["SettingssPage"],
                canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]],
            }
        ]
    },
...
var TabssRoutingModule = /** @class */ (function () {
    function TabssRoutingModule() {
    }
    TabssRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
        })
    ], TabssRoutingModule);
    return TabssRoutingModule;
}());
...
/***/ "./src/app/tabss/tabss.component.html":
/*!********************************************!*\
  !*** ./src/app/tabss/tabss.component.html ***!
  \********************************************/
/*! no static exports found */
...
module.exports = "<ion-tabs>\n  \n  <ion-tab-bar slot=\"bottom\">\n    <ion-tab-button tab=\"accountus\" href=\"/tabss/(accountus:accountus)\">\n      <ion-icon name=\"person\"></ion-icon>\n      <ion-label>Account</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"maps\"  href=\"/tabss/(maps:maps)\" (click)=\"tab2Selected()\">\n      <ion-icon name=\"map\"></ion-icon>\n      <ion-label>map</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"weathers\"  href=\"/tabss/(weathers:weathers)\" (click)=\"tab2Selected()\">\n      <ion-icon name=\"sunny\"></ion-icon>\n      <ion-label>Weather</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"settingss\"  href=\"/tabss/(settingss:settingss)\" (click)=\"tab2Selected()\">\n      <ion-icon name=\"settings\"></ion-icon>\n      <ion-label>settings</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"logout\" (click)=\"logout()\">\n      <ion-icon name=\"log-out\"></ion-icon>\n      <ion-label>Logout</ion-label>\n    </ion-tab-button>\n\n  </ion-tab-bar>\n\n  <ion-tab tab=\"accountus\">\n    <ion-router-outlet name=\"accountus\"></ion-router-outlet>\n  </ion-tab>\n\n  <ion-tab tab=\"maps\">\n    <ion-router-outlet name=\"maps\"></ion-router-outlet>\n  </ion-tab>\n\n  <ion-tab tab=\"weathers\">\n    <ion-router-outlet name=\"weathers\"></ion-router-outlet>\n  </ion-tab>\n\n  <ion-tab tab=\"settingss\">\n    <ion-router-outlet name=\"settingss\"></ion-router-outlet>\n  </ion-tab>\n  \n</ion-tabs>\n"

/***/ }),

/***/ "./src/app/tabss/tabss.component.scss":
/*!********************************************!*\
  !*** ./src/app/tabss/tabss.component.scss ***!
  \********************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3RhYnNzL3RhYnNzLmNvbXBvbmVudC5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/tabss/tabss.component.ts":
/*!******************************************!*\
  !*** ./src/app/tabss/tabss.component.ts ***!
  \******************************************/
/*! exports provided: TabssComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabssComponent", function() { return TabssComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/auth.service */ "./src/app/services/auth.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var TabssComponent = /** @class */ (function () {
    function TabssComponent(authService) {
        this.authService = authService;
    }
    TabssComponent.prototype.ngOnInit = function () {
    };
    TabssComponent.prototype.tab2Selected = function () {
        console.log('My tab was selected!');
    };
    TabssComponent.prototype.logout = function () {
        this.authService.logout();
    };
    TabssComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-tabss',
            template: __webpack_require__(/*! ./tabss.component.html */ "./src/app/tabss/tabss.component.html"),
            styles: [__webpack_require__(/*! ./tabss.component.scss */ "./src/app/tabss/tabss.component.scss")]
        }),
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]])
    ], TabssComponent);
    return TabssComponent;
}());
...
/*!***************************************!*\
  !*** ./src/app/tabss/tabss.module.ts ***!
  \***************************************/
/*! exports provided: TabssModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabssModule", function() { return TabssModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _tabss_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tabss-routing.module */ "./src/app/tabss/tabss-routing.module.ts");
/* harmony import */ var _tabss_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tabss.component */ "./src/app/tabss/tabss.component.ts");
/* harmony import */ var _pages_accountus_accountus_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pages/accountus/accountus.module */ "./src/app/pages/accountus/accountus.module.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _pages_maps_maps_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../pages/maps/maps.module */ "./src/app/pages/maps/maps.module.ts");
/* harmony import */ var _pages_weathers_weathers_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../pages/weathers/weathers.module */ "./src/app/pages/weathers/weathers.module.ts");
/* harmony import */ var _pages_settingss_settingss_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../pages/settingss/settingss.module */ "./src/app/pages/settingss/settingss.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TabssModule = /** @class */ (function () {
    function TabssModule() {
    }
    TabssModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"],
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _tabss_routing_module__WEBPACK_IMPORTED_MODULE_2__["TabssRoutingModule"],
                _pages_accountus_accountus_module__WEBPACK_IMPORTED_MODULE_4__["AccountusPageModule"],
                _pages_maps_maps_module__WEBPACK_IMPORTED_MODULE_6__["MapsPageModule"],
                _pages_weathers_weathers_module__WEBPACK_IMPORTED_MODULE_7__["WeathersPageModule"],
                _pages_settingss_settingss_module__WEBPACK_IMPORTED_MODULE_8__["SettingssPageModule"]
            ],
            declarations: [_tabss_component__WEBPACK_IMPORTED_MODULE_3__["TabssComponent"]]
        })
    ], TabssModule);
    return TabssModule;
}());
...
module.exports = __webpack_require__(/*! C:\Users\dell\Desktop\projectka3\SmartCare\test2\SmartCare\src\main.ts */"./src/main.ts");
